...
local message = string.format("Weshky Hub Got Executed From %s (UserID: %d)", username, userid)
...
UNC.Transparency = 1
UNC.Text = "Warning: The most executor under 75% sUNC dosent execute some Functions like Modding Weapons!!"
