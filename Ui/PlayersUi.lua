...
Teleport.BackgroundTransparency = 0.7
...
TextButton.BackgroundTransparency = 0.73
TextButton.BorderSizePixel = 0
TextButton.BorderColor3 = Color3.new(0, 0, 0)
TextButton.Transparency = 0.73
...
TPPRISON.Text = "Teleport to Criminal Spawn"
...
Modded_Guns.BackgroundTransparency = 0.7
Modded_Guns.BorderSizePixel = 0
Modded_Guns.BorderColor3 = Color3.new(0, 0, 0)
Modded_Guns.Transparency = 0.7
Modded_Guns.Text = "Modding Weapons"
Modded_Guns.TextColor3 = Color3.new(1, 1, 1)
Modded_Guns.TextSize = 29
