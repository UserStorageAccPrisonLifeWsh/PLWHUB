...
Antipunch.Text = "Antipunch"
Antipunch.TextColor3 = Color3.new(1, 1, 1)
Antipunch.TextSize = 16
Antipunch.TextTransparency = 0
Antipunch.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
Antipunch.TextWrapped = true
Antipunch.Parent = Extra
