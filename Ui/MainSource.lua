...
loadstring(game:HttpGet("https://raw.githubusercontent.com/UserStorageAccPrisonLifeWsh/PLWHUB/refs/heads/main/Ui/UI.lua"))()

Print("| Weshky Hub Loaded! |")

-- loadstring(game:HttpGet(""))() -- Discord Webhook!
